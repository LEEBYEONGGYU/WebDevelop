...
<div id="sub_main">
    <div id="sub_main_in">
      ...
      <h5>자유롭게 글을 쓸 수 있는 게시판입니다.<br />(오류, 요청사항 환영)</h5>
    </div>
<div id="board_area"> 
  <br>
    <table class="list-table">
        ...
        <?php
            if(isset($_GET['page'])){
              $page = $_GET['page'];
                  ...
                  $sql2 = mq("select * from free_board order by idx desc limit $start_num, $list");  
      ...
      <tbody>
        <tr>
          ...
          <td width="400">
            <?php 
              $lockimg = "<img src='/imgs/lock.png' alt='lock' title='lock' with='20' height='20' />";
              if($board['lock_post']=="1")
              { ?><a href='/page/board/bo_process/ck_read.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
              }else{?>
