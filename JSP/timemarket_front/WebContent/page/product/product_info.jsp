...
<div id="sub_content">
	<div id="sub_content_in">
		...
		<c:forEach var="row" items="${rs.rows}">
			<div id="pro_infoimg">
				...
				<div id="pro_infobox">
					<div id="pro_infot1">
						<h2>
							[<c:out value='${row["p_manuf"]}' />]
							<c:out value='${row["p_name"]}' />
							<input type="hidden" id="" value="" />
						</h2>
						<span id="pro_infocode">상품코드 : <c:out value='${row["p_code"]}' /><input type="hidden" id="pcode" name="pcode" value="<c:out value='${row["p_code"]}' />"/></span>
					</div>
					<div id="pro_infoprice">
						<c:out value='${row["p_price"]}' />원
					</div>

					<div id="pro_infentime">
						<b>남은시간 :</b>
					</div>
					<script>
		...
		<div id="pro_infoopt">
			<ul>
				...
				<li>
					...
					<div id="">
						<input type="text" id="uid" name="userid" value="<c:out value='${sessionScope.userid }'/>" />
						<input type="submit" value="구매하기" id="pro_infogubt" /> <input
							type="button" value="장바구니" id="pro_jangbt" />
					</div>
				</div>
			</div>
		...
		<div id="basket_succ" style="display: none;">선택한 상품이 장바구니에 담겼습니당
			아이좋아~</div>
		<div id="gume_succ" style="display: none;">구매가 완료되었습니다</div>
